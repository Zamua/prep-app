// Comparing a replayed response against the pair the corpus pins. Values
// that differ run to run (a minted cookie, a random slug, the VAPID key)
// are named by the corpus header and compared by regex; a rendered page is
// compared with its whitespace collapsed, since a fragment carries
// indentation that no reader depends on.
